# Napišite rekurzivnu funkciju update_tree koja će u svakom čvoru binarnog stabla 
# zamijeniti vrijednost (key) sa 0 ako je zbroj svih potomaka tog čvora paran odnosno sa 1 ako je 
# zbroj svih potomaka neparan. Zbroj se odnosi na zbroj njegovih potomaka prije zamjene 
# vrijednosti u tim potomcima. Korijen stabla definiran je atributom root, a čvorovi su iz klase: 
class TreeNode: 
